                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('main')" :active="route().current('main')">
                                    Movie World
                                </jet-nav-link>
                            </div>
                        ...
                        <template v-else>
                            <div class="hidden sm:flex sm:items-center sm:ml-6">
                                <div class="ml-3 relative">
                            <inertia-link :href="route('login')" class="text-sm text-gray-700">
                                Login
                            </inertia-link>

                            <inertia-link :href="route('register')" class="ml-4 text-sm text-gray-700">
                                Register
                            </inertia-link>
                                </div></div>
                        </template>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    ...
                    <template v-if="$page.props.user">
                        <div class="pt-2 pb-3 space-y-1">
                            <jet-responsive-nav-link :href="route('main')" :active="route().current('main')">
                                Movie World
